...
class QuitMainloopScreen(Screen):
  ...
  +			QUIT_RECOVERY_MODE: _("Your %s %s is rebooting into Recovery Mode") % (getMachineBrand(), getMachineName()), 
...
class TryQuitMainloop(MessageBox):
  ...
  +				QUIT_RECOVERY_MODE: _("Really reboot into Recovery Mode?"), 			
